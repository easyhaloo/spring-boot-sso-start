 ...
 */
public final class InheritableThreadLocalContextHolderStrategy
    implements ContextHolderStrategy {

  private static final ThreadLocal<AuthContext> CONTEXT_HOLDER = new InheritableThreadLocal<>();
